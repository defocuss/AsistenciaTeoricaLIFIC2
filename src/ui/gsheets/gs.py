...
def select_class(subject_code: str, subject_modules: list, students: pd.DataFrame,reunion_time: str) -> None:
    ...
    if st.button("Subir asistencia sheets", disabled=not all_fields_filled):
        upload_presents_spreadsheet(selected_class, selected_module, subject_code, students, reunion_time)
